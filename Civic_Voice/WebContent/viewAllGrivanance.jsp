...
<head>
  ...
  <title>Officer - View Grievances</title>
...
<div class="d-flex dashboard vh-100">
  ...
  <div class="main-content w-100 p-4">
    <h2 class="mb-4 text-center">Grievances Assigned</h2>
...
<%
    ...
    String dept = Session.getDept();  // Used to filter by department if needed

    try {
        PreparedStatement pstmt = con.prepareStatement("SELECT * FROM grievances");
